...
### Moonlight and the Roaring Falls
...
## Installation
Checkout the README file of the rice you'd like to install on your system.  
Note that some older configs might crash because of them being outdated.